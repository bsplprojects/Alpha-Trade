...
import FixedDepositHistory from "./admin/features/Funds/components/FixedDepositHistory";
...
import ConfirmFixedDeposit from "./pages/ConfirmFixedDeposit";
            ...
            <Routes>
              ...
              <Route path="/admin" element={<AdminLayout />}>
                ...
                <Route path="funds-history" element={<AdminFundHistory />}>
                  ...
                  <Route path="fd-history" element={<FixedDepositHistory />} />
                </Route>
