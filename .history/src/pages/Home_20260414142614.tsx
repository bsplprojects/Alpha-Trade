...
const Home = () => {
  ...
  return (
    <div className="page-content bg-background">
      {/* Header with balance */}
      <div className="relative overflow-hidden bg-gradient-to-r from-indigo-400 via-indigo-600 to-emerald-700 px-5 py-4 shadow-lg">
      ...
      {/* Hero Banner */}
      <div className="relative mx-3 mt-4 rounded-2xl overflow-hidden bg-gradient-to-br text-black p-6 shadow-xl ">
        {/* Shine overlay */}
        ...
        <div className="relative">
          <h2 className="text-xl font-bold  leading-tight">
            Daily returns up to
            <span className="block text-4xl font-extrabold  drop-shadow-lg animate-pulse">
              5–8%
            </span>
          </h2>

          <div className="flex items-center mt-3 flex-col w-full gap-2">
            <p className="w-full text-center text-md border p-2 rounded-xl shadow-lg backdrop-blur-sm bg-white/10">
