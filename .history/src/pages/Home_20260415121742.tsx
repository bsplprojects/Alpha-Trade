...
const Home = () => {
  ...
  return (
    <div className="page-content bg-background">
      ...
      {/* Hero Banner */}
      <div className="relative mx-3 mt-6 rounded-3xl overflow-hidden bg-gradient-to-br from-yellow-300 via-yellow-200 to-yellow-400 p-6 shadow-xl">
        ...
        <div className="relative flex flex-col gap-6 text-blue-900">
          {/* Heading */}
          <div>
            <h2 className="text-xs uppercase tracking-wider text-blue-800/70 font-medium">
              Performance Insight
            </h2>

            <p className="mt-1 text-xl font-semibold">Daily returns up to</p>

            <p className="mt-2 text-5xl font-extrabold text-blue-900">5–8%</p>
          </div>

          {/* Divider */}
          <div className="w-full h-px bg-blue-900/20" />

          {/* Info Cards */}
          <div className="grid gap-3">
            <div className="flex items-center justify-center text-center text-sm px-4 py-3 rounded-xl border border-yellow-500/40 bg-white/40 backdrop-blur-sm hover:bg-white/60 transition">
