...
const AdminDashboard = () => {
  const { data } = useQuery({
    queryKey: ["members"],
    queryFn: async () => await http.get("/DashboardForAll"),
  });
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1">
          ...
          <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-3xl shadow-lg p-6 text-white hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className=" rounded-2xl border p-2 bg-white/10 flex items-center justify-center shadow-inner">
                <User size={32} />
              </div>
            </div>
            <p className="text-5xl font-bold text-black tracking-tighter">{d?.}</p>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-3xl shadow-lg p-6 text-white hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className=" rounded-2xl flex border p-2 bg-white/10 items-center justify-center shadow-inner">
                <PiggyBank size={32} />
              </div>
            </div>
