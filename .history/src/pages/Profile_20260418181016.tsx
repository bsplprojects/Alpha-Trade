...
const menuItems2: MenuItem[] = [
  { icon: MessageSquare, label: "Message Center", path: "/message" },
...
const Profile = () => {
  ...
  return (
    <div className="page-content bg-background">
        ...
        `,
          ...
          <div className="relative flex items-center justify-between p-5 bg-white/20 backdrop-blur-md rounded-2xl mb-6 border border-white/30">
            ...
            <div className="flex items-center gap-4">
              {/* Avatar */}
              <ProfileUpload image={profileURL} onChange={handleFileChange} />
      ...
      <div className="bg-card mt-1 bg-gradient-to-r from-orange-300 to-red-500">
