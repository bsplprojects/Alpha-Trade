  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="p-5">
        ...
        <div className="max-w-xl py-10! mx-auto bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
          {/* Header */}
          ...
          {/* Address Section */}
          <div className="mb-5">
            <p className="text-sm text-gray-500 mb-1">BEP 20 USDT Address</p>
            <div className="bg-gray-100 rounded-lg p-3 break-all text-sm text-gray-800 font-medium">
          ...
          {/* Image Section */}
          <div>
            <p className="text-sm text-gray-500 mb-2">QR Code / Proof</p>
            <div className="flex justify-center">
              <img
                src={`https://api.alphatrade24.com${member?.Nominee_Relation}`}
                alt="QR Code"
                className="w-40 h-40 object-contain rounded-xl border border-gray-200 shadow-sm"
              />
            </div>
          </div>
        </div>
