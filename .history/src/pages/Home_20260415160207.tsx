...
const Home = () => {
  ...
  return (
    <div className="page-content bg-background">
      {/* Header */}
      <div className="relative mx-4 mt-4 rounded-2xl bg-gradient-to-br from-blue-100 via-blue-500 to-blue-600 p-5 shadow-xl text-white ">
        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-2xl font-semibold tracking-wide text-yellow-500">
                Alpha Trade
              </h1>
          ...
          <div className="text-right">
            <p className="text-xs uppercase tracking-wider text-slate-800">
              Total Assets
            </p>
