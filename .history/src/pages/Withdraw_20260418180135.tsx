...
import {useWithdrawl} from "../admin/features/Withdrawl/" 
...
const Withdraw = () => {
  ...
  const handleConfirm = () => {
    ...
    if (Number(amount) < 5 || Number(amount) >= 501) {
      toast.error("Please enter amount between 5 to 501");
      return;
    }
      ...
      <div className="mx-4 mt-4 bg-card rounded-xl p-4">
        ...
        <div className="bg-red-50 rounded-lg p-4 space-y-4">
          <p className="text-foreground">
            ...
            Withdrawal time:{" "}
            <span className="text-primary font-semibold underline">24 X 7</span>
            <br />
            Amount range:{" "}
            <span className="text-primary font-semibold">$5 - $500</span>.
          </p>
