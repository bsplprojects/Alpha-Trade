...
const Assets = () => {
  ...
  return (
    <div className="page-content bg-background">
      ...
      {/* Quick Actions */}
      <div className="grid grid-cols-2 gap-4 py-2 px-4 bg-card border-b border-border bg-orange-500">
        <Link
          to={"/recharge"}
          className="flex flex-col items-center gap-2 text-black hover:text-yellow-500 transition"
        >
          <CreditCard size={24} />
