...
const Popup = ({ isOpen, onClose, title, children }: any) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[99999] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative z-[100000] md:w-[25%] w-[] max-w-md bg-white rounded-2xl shadow-2xl p-6 animate-in fade-in zoom-in-95">
        ...
        <div className="w-full max-w-md px-6">
          <div className="rounded-3xl shadow-2xl border border-indigo-100 p-8 bg-white">
            ...
            <header className="text-center mb-8">
              <img src={logo} alt="" width={200} className="mx-auto mb-4" />
