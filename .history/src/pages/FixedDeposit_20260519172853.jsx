    ...
    <main>
      ...
      <section className="mx-4 my-8 flex flex-col gap-4">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-orange-100 p-6">
          <h3 className="font-semibold text-lg text-orange-950 mb-4 flex items-center gap-2">
          ...
          <div className="space-y-2">
            {channels.map((channel) => (
              ...
              >
                <div>
                  <div className="font-medium text-orange-950 text-base">
                    {channel.name}
                  </div>
                  {channel.range && (
                    <div className="text-sm text-orange-600/80 mt-0.5">
                ...
                {selectedChannel === channel.id ? (
                  <div className="w-7 h-7 rounded-full border-2 border-orange-500 bg-orange-500  flex items-center justify-center flex-shrink-0">
                    <Check size={16} className="text-orange-500" />
                  </div>
                ) : (
                  <div className="w-7 h-7 rounded-full border-2 border-orange-200" />
                )}
              </button>
            ))}
          </div>
