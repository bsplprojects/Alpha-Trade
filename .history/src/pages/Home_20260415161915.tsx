    ...
    <div className="page-content bg-black/90 min-h-screen ">
        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-blue-200 to-violet-300 shadow-lg shadow-blue-500/30">
                <img
                  src={logo}
                  alt="Alpha Trade"
                  className="w-14 h-12 object-contain drop-shadow-md"
                />
              </div>
              {/* Status indicator */}
      ...
      <div className="mx-4 mt-8 bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-400/20 rounded-2xl p-5">
        <div className="flex items-center gap-3">
          <div className="text-3xl"><Clock1 color="black" size={36}/></div>
          <div>
