          ...
          <div className="relative flex items-center justify-between p-5 bg-white/20 backdrop-blur-md rounded-2xl mb-6 border border-white/30">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative group">
                {data?.Placement ? (
                  <div className="w-16 h-16 rounded-2xl bg-white/50 flex items-center justify-center text-3xl shadow-md ring-2 ring-white/50">
                  ...
                  <>
                    <label
                      htmlFor="selfie"
                      className="w-16 h-16 rounded-2xl bg-white/50 flex items-center justify-center text-3xl shadow-md ring-2 ring-white/50"
                    >
                ...
                {/* Online Status */}
                <label htmlFor="selfie" className="absolute -bottom-1 -right-1 w-4 h-4 bg-green-500 border-[3px] border-white rounded-full animate-pulse">C</label>
              </div>
