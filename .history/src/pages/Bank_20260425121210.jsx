  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="p-5">
        ...
        <div className="max-w-xl mt-5! mx-auto bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
          {/* Header */}
          ...
          <div>
            ...
            <div className="flex justify-center">
              <img
                ...
                alt="QR Code"
                className="w-32 h-40 object-contain rounded-xl border border-gray-200 shadow-sm"
              />
            </div>
          </div>
        </div>
