...
const Home = () => {
  ...
  return (
    <div className="page-content bg-background">
      {/* Header with balance */}
      <div className="relative mx-3 mt-4 rounded-3xl overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 p-5 shadow-2xl text-white">
        {/* Glow accents */}
        <div className="absolute -top-16 -right-16 w-64 h-64 bg-indigo-500/20 rounded-full blur-3xl" />
        <div className="absolute -bottom-16 -left-16 w-64 h-64 bg-purple-500/20 rounded-full blur-3xl" />
        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Smart AI Trading</p>
            </div>
          </div>

          {/* Right: Assets */}
          <div className="text-right">
            <p className="text-xs uppercase tracking-tighter text-zinc-400">
              Total Assets
            </p>

            <h1 className="mt-1 text-3xl font-extrabold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
      ...
      {/* Hero Banner */}
      <div className="relative mx-3 mt-6 rounded-3xl overflow-hidden bg-gradient-to-br  text-black p-6 shadow-2xl">
        {/* Content */}
        <div className="relative flex flex-col gap-5">
          {/* Heading */}
          <div>
            <h2 className="text-sm uppercase tracking-tight text-zinc-600">
              Performance Insight
            </h2>

            <p className="mt-1 text-2xl font-semibold text-zinc-700">
              Daily returns up to
            </p>

            <p className="text-5xl font-extrabold bg-gradient-to-r from-indigo-600 to-purple-700 bg-clip-text text-transparent">
              5–8%
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="flex items-center justify-center text-center text-sm px-4 py-3 rounded-xl border border-indigo-500 shadow  bg-indigo-300/20 backdrop-blur-md hover:bg-white/10 transition">
              🤖 Powered by advanced AI trading systems
            </div>

            <div className="flex items-center justify-center text-center text-sm px-4 py-3 rounded-xl border border-indigo-500 shadow  bg-indigo-300/20backdrop-blur-md hover:bg-white/10 transition">
              ⏰ Trading Time:
      ...
      <div className="grid grid-cols-2 gap-4 px-3 mt-5">
        ...
        <button
          ...
          className="group rounded-2xl bg-gradient-to-br from-indigo-600 to-indigo-800 p-4 shadow-md hover:shadow-lg transition-all"
        >
      ...
      {/* Referral Banner */}
      <div className="relative mx-3 mt-4 rounded-2xl overflow-hidden bg-gradient-to-r from-indigo-800 via-indigo-900 to-indigo-800 p-5 text-white shadow-lg">
