  ...
  return (
    <main>
      ...
      <section className="mx-4 my-8 flex flex-col gap-4">
        <div className="w-full max-w-sm rounded-2xl p-5 bg-gradient-to-br from-orange-400 to-red-500 text-black shadow-xl">
          {/* Top Label */}
          ...
          <div className="mt-4 flex items-center justify-between text-xs opacity-70">
            ...
            <span className="bg-black/10 px-2 py-1 rounded-md">Wallet</span>
          </div>
        </div>
