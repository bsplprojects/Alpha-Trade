  ...
  return (
    <div className="page-content bg-white min-h-screen">
      ...
      <div className="px-4 mt-6 grid grid-cols-2 gap-4">
        ...
        >
          <div className="w-16 h-16 mb-4 rounded-2xl bg-gradient-to-br  flex items-center justify-center  shadow-inner group-hover:scale-110 transition-transform">
            <svg
          ...
          <small className="font-semibold text-yellow-500 text-xs text-nowrap hidden">
