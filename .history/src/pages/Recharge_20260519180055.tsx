    ...
    <div className="page-content bg-gradient-to-br from-slate-50 via-white to-emerald-50 min-h-screen pb-8 relative">
      ...
      <div className="px-4 pt-6 space-y-6">
        ...
        <div className="w-full space-y-2">
          <label className="text-sm font-semibold tracking-wide bg-gradient-to-r from-gold-light to-gold-dark bg-clip-text text-transparent">
            Transaction Type
          </label>

          <Select>
            <SelectTrigger className="h-14 rounded-2xl border border-gold-dark/30 bg-dark-black/80 backdrop-blur-xl text-white shadow-lg hover:border-gold-light/60 focus:ring-2 focus:ring-gold-dark/40 transition-all">
              <SelectValue placeholder="Select Transaction Type" />
            </SelectTrigger>

            <SelectContent className="rounded-2xl border border-gold-dark/30 bg-[#0d0d0d] text-white backdrop-blur-xl shadow-2xl">
              <SelectItem
                value="inr"
                className="rounded-xl cursor-pointer focus:bg-gradient-to-r focus:from-gold-light/20 focus:to-gold-dark/20 focus:text-gold-light"
              >
