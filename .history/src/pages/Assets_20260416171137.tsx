    ...
    <div className="page-content bg-background">
      ...
      <div className="mx-4 mt-6">
        ...
        `,
          ...
          {/* HEADER - Total Assets */}
          <div className="flex items-start justify-between bg-white/10 backdrop-blur-md p-5 rounded-2xl mb-6 relative z-10">
            <div>
            ...
            <button className="text-orange-200 hover:text-white transition p-2">
              <RotateCw size={22} />
            </button>
          </div>
