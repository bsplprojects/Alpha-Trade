      ...
      <div className="mx-4 mt-6">
        ...
        `,
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Link className="flex shadow-lg shadow-orange-700 border border-white/30  items-start justify-between bg-white/10 backdrop-blur-md p-5 rounded-2xl mb-6 relative z-10">
              <div>
                <div className="text-4xl font-bold tracking-tight">
