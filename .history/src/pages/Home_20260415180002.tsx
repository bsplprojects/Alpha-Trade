  ...
  <div className="flex items-start gap-4">
    ...
    <div className="flex-1 min-w-0">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-semibold text-lg text-emerald-950">Your Referral Link</h3>
        
        {/* Copy Button */}
        <button
          onClick={() => {
            navigator.clipboard.writeText("https://alphatrade24.com/signup?ref=AT11111");
      ...
      <p className="mt-4 text-sm text-slate-600 leading-relaxed">
        Share this link with your friends and earn rewards when they sign up and trade. 
        <span className="text-emerald-600 font-medium"> Earn up to 5% commission</span> on their activity.
      </p>
    </div>
  </div>
</div>
