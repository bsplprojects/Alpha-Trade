      ...
      <main className="min-h-screen flex items-center overflow-y-scroll justify-center bg-gradient-to-br from-slate-50 via-white to-emerald-50 isolate">
        <div className="w-full max-w-md  py-8 ">
          <div className="rounded-3xl shadow-xl border border-emerald-100/80 bg-white overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-orange-400 to-red-600 px-8 py-8 text-center relative">
              ...
              <form onSubmit={handleSignup} className="space-y-6">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="pl-12 h-12 border-orange-100 focus:border-orange-500 focus:ring-orange-500 transition-all text-base"
                    required
                  />
                </div>
                ...
                {/* Invitation Code */}
                <div className="relative group">
                  <MailOpen className="absolute left-4 top-1/2 -translate-y-1/2 text-orange-500 w-5 h-5" />
                  <Input
                    type="text"
                ...
                <div className="flex items-start gap-3 pt-2">
                  <Checkbox
                    ...
                    className="mt-0.5 border-orange-300 data-[state=checked]:bg-orange-600 data-[state=checked]:border-orange-600"
                  />
                  <label className="text-sm text-slate-600 leading-relaxed">
                    I agree to the{" "}
                    <Link
                      to="/terms"
                      className="text-orange-600 hover:text-emerald-700 font-medium transition-colors"
                    >
                      Terms of Service
                    </Link>{" "}
                    and{" "}
