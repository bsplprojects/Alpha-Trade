        ...
        `,
          ...
          <div className="flex shadow-lg shadow-orange-700  items-start justify-between bg-white/10 backdrop-blur-md p-5 rounded-2xl mb-6 relative z-10">
            <div>
              ...
              <div className="text-sm text-orange-200 mt-1">Total Assets</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 relative z-10">
            {/* Total Deposit */}
            <div className="bg-white/10 backdrop-blur-md shadow-lg shadow-orange-700  p-4 rounded-2xl text-center">
            ...
            <button
              ...
              className="bg-white/10 backdrop-blur-md p-4 shadow-lg shadow-orange-700  rounded-2xl text-center hover:bg-white/15 transition-all active:scale-[0.98]"
            >
              <div className="text-3xl font-bold">
            ...
            <button
              ...
              className="col-span-2 bg-white/10 backdrop-blur-md shadow-lg shadow-orange-700  p-4 rounded-2xl text-center hover:bg-white/15 transition-all active:scale-[0.98]"
            >
              <div className="text-3xl font-bold">
          ...
          {/* Bottom Branding */}
          <div className="flex justify-center mt-8 opacity-75 shadow-lg shadow-orange-700  relative z-10">
