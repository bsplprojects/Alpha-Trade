...
const Home = () => {
  ...
  return (
    <div className="page-content bg-background">
      {/* Header with balance */}
      <div className="relative overflow-hidden bg-gradient-to-r from-indigo-300 via-indigo-600 to-emerald-700 px-5 py-4 shadow-lg">
        <div className="absolute inset-0 bg-white/10 backdrop-blur-sm" />

        <div className="relative flex items-center justify-between">
          <div className="h-16 w-16 rounded-full flex items-center justify-center text-white text-xl"></div>
      ...
      {/* Hero Banner */}
      <div className="relative mx-3 mt-4 rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-500 to-indigo-600 p-6 shadow-xl shadow-indigo-500/40">
        {/* Shine overlay */}
        <div className="absolute inset-0 bg-white/10 backdrop-blur-sm" />
        ...
        <div className="relative">
          <h2 className="text-xl font-bold text-white leading-tight">
            Daily returns up to
            <span className="block text-4xl font-extrabold text-indigo-100 drop-shadow-lg animate-pulse">
              5–8%
            </span>
          </h2>

          <div className="flex items-center mt-3 flex-col w-full gap-2">
            <p className="w-full text-center text-md text-indigo-100 border p-2 rounded-xl shadow-lg backdrop-blur-sm bg-white/10">
              🤖 Powered by advanced AI trading systems
            </p>

            <p className="w-full text-center text-md text-indigo-100 border p-2 rounded-xl shadow-lg backdrop-blur-sm bg-white/10">
              ⏰ Trading Time:{" "}
              <span className="font-semibold text-white underline decoration-white/50">
                07:00 PM – 08:00 PM
              </span>
            </p>
          </div>
