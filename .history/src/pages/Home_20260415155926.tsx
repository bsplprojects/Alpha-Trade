...
const Home = () => {
  ...
  return (
    <div className="page-content bg-background">
      {/* Header */}
      <div className="relative mx-4 mt-4 rounded-2xl bg-gradient-to-br from-slate-100 via-slate-500 to-slate-900 p-5 shadow-xl text-white border border-white/10">
