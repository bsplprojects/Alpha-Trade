...
const Home = () => {
  ...
  return (
    <div className="page-content bg-white min-h-screen ">
      {/* Header - Premium Card */}
      <div className="relative mx-4 mt-6 rounded-3xl bg-white border border-emerald-100 shadow-xl p-5 sm:p-6 overflow-hidden">
        {/* Subtle Pista Background Accent */}
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-white to-teal-50 opacity-80" />
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="relative">
              <div className="p-3 bg-emerald-100 rounded-2xl">
                <img
                  src={logo}
                  alt="Alpha Trade"
                  className="w-16 h-16 sm:w-14 sm:h-14 object-contain drop-shadow-sm"
                />
              </div>

              {/* Online Status Indicator */}
              <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 bg-emerald-500 rounded-full border-[2.5px] border-white shadow-sm" />
            </div>
          ...
          <div className="text-left sm:text-right border-t sm:border-none border-emerald-100 pt-4 sm:pt-0">
            <p className="text-xs uppercase tracking-widest text-emerald-600/70 font-medium">
              TOTAL ASSETS
            </p>

            <div className="flex items-baseline gap-1 sm:justify-end mt-1">
              <span className="text-4xl font-bold text-emerald-700 tracking-tighter">
