      ...
      <div className="mx-3 mt-6">
        ...
        `,
          ...
          <div className="flex justify-center mb-4 relative z-10">
            <div className="bg-white/20 backdrop-blur-md text-black/70 text-xs font-medium px-6 py-1.5 rounded-full border border-white/30 flex items-center gap-2">
          ...
          <div className="flex flex-col gap-5 bg-green-500 ">
            {/* Team Deposit */}
