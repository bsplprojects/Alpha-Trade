...
const Home = () => {
  ...
  return (
    <div className="page-content bg-white min-h-screen ">
      {/* Header - Premium Card */}
      <div className="relative mx-4 mt-6 rounded-3xl bg-gradient-to-br from-sky-400 via-blue-500 to-indigo-500 border border-white/30 shadow-2xl p-5 sm:p-6 overflow-hidden">
        {/* Shiny overlay for glossy effect */}
        <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-transparent to-white/10" />

        {/* Subtle highlight shine */}
        <div className="absolute inset-0 bg-[radial-gradient(at_top_right,#ffffff40_0%,transparent_50%)]" />
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="relative">
              <div className="p-3 bg-white/20 backdrop-blur-md rounded-2xl border border-white/30">
                <img
                  src={logo}
                  alt="Alpha Trade"
                  className="w-16 h-16 sm:w-14 sm:h-14 object-contain drop-shadow-md brightness-110"
                />
              </div>

              {/* Live Status Indicator */}
              <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 bg-emerald-400 rounded-full border-[2.5px] border-white shadow-lg animate-pulse" />
            </div>
          ...
          <div className="text-left sm:text-right border-t sm:border-none border-white/20 pt-4 sm:pt-0">
            <p className="text-xs uppercase tracking-[2px] text-white/70 font-medium">
              TOTAL ASSETS
            </p>
