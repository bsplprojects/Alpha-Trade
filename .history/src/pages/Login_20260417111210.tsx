            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-12 h-12 border-orange-100 focus:border-orange-500 focus:ring-orange-500 rounded-2xl text-base transition-all"
                  required
                />
              </div>
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-12 pr-12 h-12 border-orange-100 focus:border-orange-500 focus:ring-orange-500 rounded-2xl text-base transition-all"
                  required
                />
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-orange-400 hover:text-emerald-600 transition-colors"
                >
                  {showPassword ? (
