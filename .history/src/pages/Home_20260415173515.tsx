...
const Home = () => {
  ...
  return (
    <div className="page-content bg-white min-h-screen ">
      {/* Header - Premium Card */}
      <div className="relative mx-0 mt-2 rounded-3xl bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800/80 p-5 sm:p-6 shadow-2xl overflow-hidden">
        {/* Background glow */}
