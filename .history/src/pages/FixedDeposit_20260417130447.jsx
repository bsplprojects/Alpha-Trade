    ...
    <main>
      ...
      <section>
        <Table>
          ...
          <TableBody>
            {fds?.data?.map((fd, index) => (
              <TableRow key={fd?.Date}>
                <TableCell className="font-medium">{fd?.Date}</TableCell>
                <TableCell>{fd.paymentStatus}</TableCell>
                <TableCell>{fd.paymentMethod}</TableCell>
