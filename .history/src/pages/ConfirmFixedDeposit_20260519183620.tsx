...
import inr_deposit_qr from "../../assets/inr_deposit_qr.jpg";
...
const ConfirmFixedDeposit = () => {
  ...
  const { channel, amount, type } = location.state || {};
  ...
  const handleSubmit = async () => {
    ...
    formData.append("time", data.timePeriod);
    formData.append("Amount", (currentAmount / usdtInrRate).toFixed(2));
    formData.append("HashID", data.txnId);
    ...
    <main className="page-content">
      ...
      {type === "usdt" ? (
        ...
        <>
          <div className="w-full flex items-center justify-center ">
            <div className="py-5">
              <img src={inr_deposit_qr} alt="inr_deposit_qr" width={300} />
            </div>
          </div>

          <h1 className="px-12">Amount</h1>
          <p className="px-2 py-2 bg-white/70 rounded-sm mx-10">{amount}</p>
        </>
      )}
      ...
      <div className="px-10 mt-5">
        ...
        <Select
          ...
          onValueChange={(val) =>
            setData((prev) => ({ ...prev, timePeriod: val }))
          }
        >
          <SelectTrigger>
          ...
          <SelectContent>
            <SelectItem value={}>6 Months</SelectItem>
...
export default ConfirmFixedDeposit;
