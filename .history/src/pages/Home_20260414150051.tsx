      ...
      <div className="relative mx-3 mt-6 rounded-3xl overflow-hidden bg-gradient-to-br  text-black p-6 shadow-2xl">
        ...
        <div className="relative flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="flex items-center justify-center text-center text-sm px-4 py-3 rounded-xl border border-indigo-500 shadow  bg-indigo-300 backdrop-blur-md hover:bg-white/10 transition">
