...
const Assets = () => {
  ...
  return (
    <div className="page-content bg-background">
      ...
      {/* Quick Actions */}
      <div className="grid grid-cols-3 mt-5 mx-3 rounded-xl gap-4 py-2 px-4 bg-card border-b border-border bg-gradient-to-r from-orange-500/50 to-red-500/50">
        <Link
          to={"/recharge"}
      ...
      <div className="mx-4 mt-6">
        ...
        `,
          ...
          <div className="grid grid-cols-1 gap-1">
            <div className=" shadow-lg  shadow-orange-700 border border-white/30  bg-white/10 backdrop-blur-md p-5 rounded-2xl mb-6 relative z-10">
            ...
            <Link
              to="/fixed-deposit"
              className=" shadow-lg shadow-orange-700 border border-white/30  i bg-white/10 backdrop-blur-md p-5 rounded-2xl mb-6 relative z-10"
            >
              <div className="flex flex-col-reverse items-center">
                <div className="text-4xl font-bold tracking-tight">
          ...
          <div className="flex flex-col  gap-4 relative z-10">
            {/* Total Deposit */}
            <div className="bg-white/10 flex flex-col backdrop-blur-md border border-white/30 shadow-lg shadow-orange-700  p-4 rounded-2xl text-center ">
