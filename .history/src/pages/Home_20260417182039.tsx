...
const Home = () => {
  ...
  return (
    <div className="page-content bg-white min-h-screen">
      {/* Header - Premium Card */}
      <div className="relative mx-4 mt-2 rounded-3xl bg-gradient-to-r from-orange-500/50 to-red-500/50 border border-orange-800/80 p-5 sm:p-6 shadow-2xl overflow-hidden">
        {/* Background glow */}
