...
const Profile = () => {
  ...
  return (
    <div className="page-content bg-background">
          ...
          <div className="relative flex items-center justify-between p-5 bg-white/20 backdrop-blur-md rounded-2xl mb-6 border border-white/30">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative group">
                ...
                <input type="file" className="hidden" id="selfie" />
      ...
      {/* Menu Items */}
      <div className="bg-card mt-2 bg-gradient-to-r from-orange-300 to-red-200">
      ...
      <div className="bg-card mt-2 bg-gradient-to-r from-orange-200 to-red-200">
