...
const Assets = () => {
  ...
  return (
    <div className="page-content bg-background">
      ...
      {/* Quick Actions */}
      <div className="grid grid-cols-2 mt-5 mx-3 rounded-xl gap-4 py-2 px-4 bg-card border-b border-border bg-gradient-to-r from-orange-500/50 to-red-500/50">
        <Link
          to={"/recharge"}
        ...
        >
          <ArrowDownToLine size={24} />
          <span className="text-sm">Fixed D</span>
        </Link>
      </div>
