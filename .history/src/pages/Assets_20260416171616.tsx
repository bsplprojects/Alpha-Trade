        ...
        `,
          ...
          <div className="grid grid-cols-2 gap-4 relative z-10">
            ...
            <button
              ...
              className="col-span-2 bg-white/10 border-white/30 backdrop-blur-md shadow-lg shadow-orange-700  p-4 rounded-2xl text-center hover:bg-white/15 transition-all active:scale-[0.98]"
            >
              <div className="text-3xl font-bold">
