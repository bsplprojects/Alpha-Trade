  ...
  return (
    <div className="page-content bg-background">
      ...
      <div className=" p-4 pb-8">
        <div className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-br from-yellow-400 to-yellow-500 text-blue-600 shadow-xl">
          {/* LEFT */}
          <div className="flex items-center gap-4">
            {/* Avatar */}
            <div className="relative">
              <div className="w-14 h-14 rounded-full bg-blue-800/40 text-blue-800 flex items-center justify-center text-2xl shadow-lg">
                <User />
              </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2 text-sm text-blue-800">
                ...
                <span className="font-mono tracking-wider font-">
                  {data?.ConsumerID}
                </span>
                ...
                <button
                  ...
                  className="ml-1 text-blue-800 hover:text-white transition"
                >
                  <Copy size={15} />
                </button>
              </div>
