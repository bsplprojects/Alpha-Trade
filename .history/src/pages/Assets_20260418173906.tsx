      ...
      <div className="mx-4 mt-6">
        ...
        `,
          ...
          <div className="grid grid-cols-1 gap-1">
            <div className="flex shadow-lg  shadow-orange-700 border border-white/30  items-center  justify-between bg-white/10 backdrop-blur-md p-5 rounded-2xl mb-6 relative z-10">
              <div>
                <div className="text-4xl font-bold tracking-tight">
                  ${data?.data[0]?.LevelIncome || 0}
                </div>
                <div className="text-sm text-black/80 mt-1 bg-green-500 w-full!">Total Assets</div>
              </div>
            </div>
            <Link
              to="/fixed-deposit"
